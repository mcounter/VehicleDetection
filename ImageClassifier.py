...
class ImageClassifier:
    ...
    def fit(
        self,
        train_data, # Train data DeepDataEngine object
        ...
        if isinstance(train_data, DeepDataEngine):
    ...
    def score(
        ...
        if isinstance(valid_data, DeepDataEngine):
    ...
    def predict(
        ...
        if isinstance(x_data, DeepDataEngine):
            x_data, y_data = valid_data.readAllData()
