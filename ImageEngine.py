    ...
    def getImageFeatures(
        ...
        for y_pos in range(0, img_shape[0], feature_stride[0]):
            ...
            for x_pos in range(0, img_shape[1], feature_stride[1]):
                ...
                res_features += [[(y_pos_src + img_window[0], x_pos_src + img_window[1]), (y_pos_src + img_window[0] + featureSizeSrc[0], x_pos_src + img_window[1] + featureSizeSrc[1]), features_sub]]
                if visualise:
                    res_vis += [vis_sub]
